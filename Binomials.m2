...
singsolve = (I) -> (
     ...
     -- print cl;
     result := {};  -- Will hold the final list of solutions
     l := {}; -- Will hold a single solution at a time
     
     numvars := #varlist;  -- Number of variables should divide length of cl.
     numsols := sub(#cl / numvars, ZZ); -- ... and give number of solutions
     print numsols;
     for i in (0..(numsols-1)) do(
	  l := {};
